...
<form method="POST" action="article-create.php">
    ...
    <label>
        Perex (krátky úvodný odstavec) *
        <textarea name="perex" rows="3" minlength="10" maxlength="500" required><?php echo htmlspecialchars($_POST['perex'] ?? ''); ?></textarea>
    </label>

    <label>
        Obsah *
        <textarea name="content" rows="15" minlength="20" required><?php echo htmlspecialchars($_POST['content'] ?? ''); ?></textarea>
    </label>
